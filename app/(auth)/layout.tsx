      ...
      <div className="relative hidden w-1/2 flex-col justify-between bg-zinc-50 p-12 lg:flex border-r border-border overflow-hidden">
        ...
        <div className="relative z-10 my-auto max-w-lg space-y-8">
          <div className="space-y-4">
            <h1 className="text-4xl font-extrabold tracking-tight leading-tight bg-linear-to-br from-zinc-900 via-zinc-800 to-zinc-600 bg-clip-text text-transparent">
