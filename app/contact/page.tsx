...
export const metadata = {
  ...
  description:
    "Get in touch with Niraj Pujari for technical support, feedback, or inquiries regarding Dootx.",
};
      ...
      <main className="max-w-4xl mx-auto px-6 space-y-10">
        <div className="space-y-4 text-center border-b border-zinc-850 pb-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-violet-600/10 border border-violet-500/20 text-violet-300 text-xs font-semibold uppercase tracking-wider">
            <MessageSquare className="h-3.5 w-3.5" /> Direct Developer
            Communication
          </div>
          ...
          <p className="text-zinc-400 text-base max-w-xl mx-auto leading-relaxed">
            Have questions, feedback, technical inquiries, or feature
            suggestions for Dootx? Reach out directly to developer{" "}
            <strong>Niraj Pujari</strong>.
          </p>
        </div>
        ...
        <div className="p-8 rounded-2xl bg-zinc-900/70 border border-zinc-800 shadow-2xl space-y-6 max-w-2xl mx-auto text-center">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-zinc-400 font-mono">
              Lead Full-Stack Developer of Dootx
            </p>
          </div>

          <p className="text-sm text-zinc-300 max-w-md mx-auto leading-relaxed">
            Feel free to send an email regarding technical support, Google OAuth
            integration guidance, or general inquiries.
          </p>
        ...
        <div className="grid gap-6 sm:grid-cols-3 max-w-3xl mx-auto pt-6">
          <div className="p-5 rounded-xl bg-zinc-900/40 border border-zinc-850 space-y-2 text-center">
            ...
            <p className="text-xs text-zinc-400">
              Assistance with Google OAuth credentials, database setups, and
              campaign dispatches.
            </p>
          </div>
          ...
          <div className="p-5 rounded-xl bg-zinc-900/40 border border-zinc-850 space-y-2 text-center">
            ...
            <p className="text-xs text-zinc-400">
              Share your roadmap suggestions and custom variable requirements.
            </p>
          </div>
          ...
          <div className="p-5 rounded-xl bg-zinc-900/40 border border-zinc-850 space-y-2 text-center">
            ...
            <p className="text-xs text-zinc-400">
              Partnership opportunities, architecture questions, and project
              feedback.
            </p>
          </div>
        </div>
